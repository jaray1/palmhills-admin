				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<select name="description" id="" class="custom-select" required>
									<option selected="" value="" disabled="">Please choose street.</option>
									<option name="SAHANOFO" value="SAHANOFO">SAHANOFO</option>
									<option name="GUARIKA" value="GUARIKA">GUARIKA</option>
									<option name="FOXTAIL" value="FOXTAIL">FOXTAIL</option>
									<option name="VELVET" value="VELVET">VELVET</option>
								</select>
								</div>
							<div class="form-group">
								<label class="control-label">HOA Fee</label>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										...
										<p><small>Street: <b><?php echo $row['description'] ?></b></small></p>
										<p><small>HOA Fee: <b><?php echo number_format($row['price'],2) ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-info edit_house" type="button" data-id="<?php echo $row['id'] ?>"  data-house_no="<?php echo $row['house_no'] ?>" data-description="<?php echo $row['description'] ?>" data-category_id="<?php echo $row['category_id'] ?>" data-price="<?php echo $row['price'] ?>" >Edit</button>
